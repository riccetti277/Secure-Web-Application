...
declare type WebCryptoAlgorithmSuiteValues = WebCryptoAesGcm & Partial<Omit<AlgBasic, keyof WebCryptoAesGcm>> & Partial<Omit<AlgKdf, keyof WebCryptoAesGcm>> & Partial<Omit<AlgKdfSigned, keyof WebCryptoAesGcm>> & Partial<Omit<AlgCommitted, keyof WebCryptoAesGcm>> & Partial<Omit<AlgCommittedSigned, keyof WebCryptoAesGcm>>;
