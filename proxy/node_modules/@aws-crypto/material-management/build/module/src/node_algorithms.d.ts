...
declare type NodeAlgorithmSuiteValues = NodeAesGcm & Partial<Omit<AlgBasic, keyof NodeAesGcm>> & Partial<Omit<AlgKdf, keyof NodeAesGcm>> & Partial<Omit<AlgKdfSigned, keyof NodeAesGcm>> & Partial<Omit<AlgCommitted, keyof NodeAesGcm>> & Partial<Omit<AlgCommittedSigned, keyof NodeAesGcm>>;
